...
² The Provision column covers granting and revoking entitlements, which does not apply to accounts. C1 can still create Coupa accounts — see [Account provisioning](#account-provisioning).
...
|-------|----------|-------------|
| First name | Yes | First name of the person who will own the Coupa user. |
| Last name | Yes | Last name of the person who will own the Coupa user. |
| Email | No | Email address of the Coupa user. Defaults to the C1 user's primary email. |
| Login | No | Login for the Coupa user. Defaults to the C1 user's username. |
